...
private:
    ...
    void insert_to_start(const char *index_, T value_, int pos);//insert to the node located at pos, and insert to the very start of this node

    void insert_to_end(const char *index_, T value_, int pos);//insert to the node located at pos, and insert to the very end of this node
...
template<class T>
void linkedList<T>::Split(int pos)//split the node located at pos
{
...
template<class T>
void linkedList<T>::borrow(int type, int dest_pos, int src_pos)//dest_pos borrow from src_pos, the type 1 is borrow from prev, meanwhile type 2 is borrow from next
{
...
template<class T>
void linkedList<T>::Union_to_prev(int from_pos, int to_pos) //Priority over Union_to_next()
{
...
template<class T>
void linkedList<T>::Union_to_next(int from_pos, int to_pos)
{
...
template<class T>
void linkedList<T>::insert_to_start(const char *index_, T value_, int pos)//insert to the node located at pos, and insert to the very start of this node
{
    remainder cur_rem;
...
template<class T>
void linkedList<T>::insert_to_end(const char *index_, T value_, int pos)//insert to the node located at pos, and insert to the very end of this node
{
    remainder cur_rem;
    BlockNode<T> cur_node;
    map_pair<T> to_insert(index_, value_);
...
template<class T>
std::pair<bool, std::vector<T>> linkedList<T>::find(const char *index_)
{
...
template<class T>
void linkedList<T>::insert(const char *index_, const T &value_)
{
...
template<class T>
void linkedList<T>::del(const char *index_, const T &value_)
{
...
template<class T>
std::vector<T> linkedList<T>::findAll()
{
    int cur_pos;
    file.seekg(0);
    file.read(reinterpret_cast<char *> (&cur_pos), sizeof(int));
...
template<class T>
void linkedList<T>::modify(const char *index_, const T &his_value, const T &new_value)
{
