...
template<class T>
void linkedList<T>::insert_to_start(char index_[], T value_, int pos)//insert to the node located at pos, and insert to the very start of this node
{
    remainder cur_rem;
...
template<class T>
void linkedList<T>::insert_to_end(char index_[], T value_, int pos)//insert to the node located at pos, and insert to the very end of this node
{
    remainder cur_rem;
    BlockNode<T> cur_node;
    map_pair<T> to_insert(index_, value_);
...
template<class T>
linkedList<T>::linkedList(const std::string &name)
{
